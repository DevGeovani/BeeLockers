...
<head>
    ...
    <title>Bee Lockers - Home Parceria</title>
</head>
            ...
            <div class="container-fluid">
                ...
                <div class="collapse navbar-collapse " id="nav-menu">
                    <ul class="navbar-nav ms-auto">
                        ...
                        <li class="nav-item">
                            <a href="cadastroParceria.php" class="nav-link">Inscrever-se</a>
                        </li>
                        <li class="nav-item">
                            <a href="homeParceria.php" class="nav-link">Entrar</a>
                        </li>
                    </ul>
                </div>
        ...
        <section id="home">
            <div class="container-fluid div-home ">
                ...
                <div class="row justify-content-center">
                    <form class="col-md-4 div-home" method="post" action="../model/logarParceria.php" enctype="multipart/form-data">
                        <div class="card">
                            <div class="card-body">
                                <div class="fw-bolder">
