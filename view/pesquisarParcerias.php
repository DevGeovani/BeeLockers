            ...
            <div class="container-fluid">
                ...
                <div class="card">
                    <div class="card-header text-center">
                        <h2>Administração de Parcerias</h2>
                    </div>
                            ...
                            <div class="table-responsive">
                                <table class="table align-middle table-striped table-hover" width="100%">
                                    ...
                                    <tbody>
                                        ...
                                        $sql = "SELECT * FROM parceria WHERE razao_social LIKE '%$nomePesq%'";
                                    ...
                                    <td>$cnpj</td>
                                    <td>
                                        <a href="alterarParceria.php?id_parceria=$id_parceria" class="text-decoration-none me-2"><svg version="1.1" id="Layer_1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" width="16px" height="16px" 
                                        ...
                                        <a href='../model/excluirParceria.php?id_parceria=$id_parceria'  class="text-decoration-none ms-2" ><svg version="1.1" id="Layer_1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" width="16px" height="16px"
